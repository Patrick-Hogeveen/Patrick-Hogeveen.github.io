        ...
        return (
            ...
            <div class="row">
                ...
                <div className="term">
                    ...
                    After discovering this I duplicated and transformed some of the images of the less represented classes until each had a equal share. After cleaning up the data it wa down to deciding on a model. <br/><br/><br/>
                    The first model I tried was resent18 a well known residual convolutional based network, it performed well in training and testing however when trying it against real pictures taken by a friend it seemed to misclassify very easy examples. After discovering this I then decided to try a more complex network.
